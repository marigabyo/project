<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aProduto')){ ?>
    <a href="<?php echo base_url();?>index.php/produtos/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Agregar Material</a>
<?php } ?>
...
<table class="table table-bordered ">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="5">Ningún Material Registrado</td>
        </tr>
    </tbody>
</table>
</div>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h5 id="myModalLabel">Eliminar Material</h5>
  </div>
  <div class="modal-body">
    <input type="hidden" id="idProduto" name="id" value="" />
    <h5 style="text-align: center">Desea realmente eliminar este Material?</h5>
  </div>
