...
<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aLancamento')){ ?>
  <div class="span5" style="margin-left: 0">
      <a href="#modalReceita" data-toggle="modal" role="button" class="btn btn-success tip-bottom" title="Registrar Nuevo Permiso de calle"><i class="icon-plus icon-white"></i> Nuevo Permiso de Calle</a>  
      <a href="#modalDespesa" data-toggle="modal" role="button" class="btn btn-danger tip-bottom" title="Registrar Nuevo Permiso de Central"><i class="icon-plus icon-white"></i> Nuevo Permiso de Central</a>
  </div>
<?php } ?>
...
<table class="table table-bordered ">
    <thead>
        <tr style="backgroud-color: #2D335B">
            <th>#</th>
            <th>Tipo</th>
            <th>Fecha de inicio y Fecha de finalizacion</th>
            <th>Vencimiento</th>
            <th>Status</th>
            <th>Valor</th>
            <th>Acción</th>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="6">Ningún Permiso Encontrado</td>
        </tr>
    </tbody>
</table>
</div>
...
<table class="table table-bordered " id="divLancamentos">
    ...
    <tfoot>
    	<tr>
    		<td colspan="5" style="text-align: right; color: green"> <strong>Total de permisos de calle:</strong></td>
    		<td colspan="2" style="text-align: left; color: green"><strong> <?php echo number_format($totalReceita,2,',','.') ?></strong></td>
    	</tr>
    	<tr>
    		<td colspan="5" style="text-align: right; color: red"> <strong>Total de permisos de central:</strong></td>
    		<td colspan="2" style="text-align: left; color: red"><strong> <?php echo number_format($totalDespesa,2,',','.') ?></strong></td>
    	</tr>
    	<tr>
    		<td colspan="5" style="text-align: right"> <strong>Vencimiento:</strong></td>
...
<div id="modalReceita" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    	...
    	<div class="span12" style="margin-left: 0"> 
    		<div class="span12" style="margin-left: 0"> 
    			<label for="cliente">Fecha de inicio y Fecha de finalizacion*</label>
    	...
    	<div class="span12" style="margin-left: 0"> 
    		<div class="span4" style="margin-left: 0">
    			<label for="recebido">Culminado</label>
	    		&nbsp &nbsp &nbsp &nbsp<input  id="recebido" type="checkbox" name="recebido" value="1" />	
    		</div>
    		<div id="divRecebimento" class="span8" style=" display: none">
	    		<div class="span6">
	    			<label for="recebimento">Fecha de culminacion</label>
...
>
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-success">Agregar Permisos de Calle</button>
  </div>
  </form>
</div>
...
<div id="modalDespesa" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Comfor - Agregar Permiso de Central</h3>
  </div>
  <div class="modal-body">
  		<div class="span12 alert alert-info" style="margin-left: 0"> Obligatorio llenar los campos con asterisco.</div>
    	<div class="span12" style="margin-left: 0"> 
    	...
    	<div class="span12" style="margin-left: 0"> 
    		<div class="span12" style="margin-left: 0"> 
    			<label for="fornecedor">Fecha de inicio y Fecha de finalizacion*</label>
    	...
    	<div class="span12" style="margin-left: 0"> 
    		<div class="span4" style="margin-left: 0">  
    			<label for="valor">Codigo cantv*</label>
  ...
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
    <button class="btn btn-danger">Agregar Permiso de Central</button>
  </div>
  </form>
</div>
...
<div id="modalEditar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Comfor - Editar </h3>
  </div>
  <div class="modal-body">
      <div class="span12 alert alert-info" style="margin-left: 0"> Obligatorio llenar los campos con asterisco.</div>
      <div class="span12" style="margin-left: 0"> 
...
<div id="modalExcluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Comfor- Eliminar Movimiento Financiero</h3>
  </div>
  <div class="modal-body">
