          ...
          <div class="row-fluid">
              <div class="span12">
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              <th style="font-size: 1.2em; padding: 5px;">Fecha de inicio y Fecha de finalizacion</th>
                      ...
                      <tbody>
                       ...
                       <tfoot>
                          <tr>
                            ...
                            <td colspan="2" style="text-align: left; color: green"><strong>Bsf <?php echo number_format($totalReceita,2,',','.') ?></strong></td>
                          </tr>
                          <tr>
                            <td colspan="5" style="text-align: right; color: red"> <strong>Total Gastos:</strong></td>
                            <td colspan="2" style="text-align: left; color: red"><strong>Bsf <?php echo number_format($totalDespesa,2,',','.') ?></strong></td>
                          </tr>
                          <tr>
                            <td colspan="5" style="text-align: right"> <strong>Saldo:</strong></td>
                            <td colspan="2" style="text-align: left;"><strong>Bsf<?php echo number_format($totalReceita - $totalDespesa,2,',','.') ?></strong></td>
                          </tr>
                        </tfoot>
                  </table>
