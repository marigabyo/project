    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/servicosRapid"><i class="icon-wrench"></i> <small>Todos los Proyectos</small></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url() ?>index.php/relatorios/servicosCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
                                <label for="">Numero de partida </label>
