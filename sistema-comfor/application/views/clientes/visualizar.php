                                    ...
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: right"><strong>Cedula</strong></td>
                                    ...
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: right"><strong>Número de empleado</strong></td>
                                                ...
                                                <tr>
                                                    <td style="text-align: right"><strong>Parroquia</strong></td>
