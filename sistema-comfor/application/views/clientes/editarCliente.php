        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <label for="documento" class="control-label">Cedula<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="numero" class="control-label">Número de empleado<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="bairro" class="control-label">Ciudad<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="cidade" class="control-label">Municipio<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="estado" class="control-label">Parroquia<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="cep" class="control-label">Codigo postal<span class="required">*</span></label>
                        <div class="controls">
