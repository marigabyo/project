<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aServico')){ ?>
    <a href="<?php echo base_url()?>index.php/servicos/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Agregar Proyecto</a>
<?php } ?>
...
<table class="table table-bordered ">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="5">Ningún Proyecto Registrsado</td>
        </tr>
    </tbody>
</table>
</div>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h5 id="myModalLabel">Eliminar Proyecto</h5>
  </div>
  <div class="modal-body">
    <input type="hidden" id="idServico" name="id" value="" />
    <h5 style="text-align: center">Desea realmente eliminar este Proyecto?</h5>
  </div>
